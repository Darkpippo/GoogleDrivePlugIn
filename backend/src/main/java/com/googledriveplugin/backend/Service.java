package com.googledriveplugin.backend;
...
public class Service {
    ...
    public Res uploadImageToDrive(File file) throws GeneralSecurityException, IOException {
        ...
        try {
            String folderId = "1cK-jdkKdR2ywj9wi_ffUkvKo3wT7rprc";
            Drive drive = createDriveService();
            com.google.api.services.drive.model.File fileMetaData = new com.google.api.services.drive.model.File();
            fileMetaData.setName(file.getName());
            fileMetaData.setParents(Collections.singletonList(folderId));
            FileContent mediaContent = new FileContent("image/jpeg", file); // tuka da go napravime so mimeType
